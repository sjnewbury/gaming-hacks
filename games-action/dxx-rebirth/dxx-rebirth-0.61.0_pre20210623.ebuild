...
dxx_scons() {
	...
	use d1x && mysconsargs+=( d1x_sharepath="/usr/share/d1x" d1x="$scons_build_profile,site," )
	use d2x && mysconsargs+=( d2x_sharepath="/usr/share/d2x" d2x="$scons_build_profile,site," )
